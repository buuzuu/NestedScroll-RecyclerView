...
public class CustomeBehaviour extends CoordinatorLayout.Behavior<NestedScrollView> {


    public CustomeBehaviour(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private void setPaddingBottom(MaxHeightRecyclerView view, int bottom) {
        if (view.getPaddingBottom() != bottom){
            ...
            view.setPadding(view.getPaddingBottom(),view.getPaddingTop(), view.getPaddingRight(),bottom);
